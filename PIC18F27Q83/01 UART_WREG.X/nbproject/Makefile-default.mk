...
FINAL_IMAGE=${DISTDIR}/01_UART_WREG.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/01_UART_WREG.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F27Q83
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/01_UART_WREG.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/01_UART_WREG.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F27Q83 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/01_UART_WREG.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
